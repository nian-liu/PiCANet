...
if is_server
  if strcmp(dataset, 'voc2012')
    img_folder  = '/disk1/nianliu/Data/segmentation/VOCdevkit/VOC2012/JPEGImages'
    save_folder = '/disk1/nianliu/Data/segmentation/VOCdevkit/VOC2012/PPMImages';
  elseif strcmp(dataset, 'coco')
    img_folder  = '/disk1/nianliu/Data/segmentation/coco/JPEGImages';
    save_folder = '/disk1/nianliu/Data/segmentation/coco/PPMImages';
  end
else
  img_folder = '../img';
  save_folder = '../img_ppm';
