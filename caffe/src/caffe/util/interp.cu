...
__global__ void caffe_gpu_interp2_kernel(const int n, const float rheight, const float rwidth,
    ...
    Dtype *data2, const int x2, const int y2, const int height2, const int width2, const int Height2, const int Width2, bool is_seglabel) {
  ...
  if (index < n) {
	...
	const int h1round = (h1lambda < 0.5) ? 0 : 1;
    //
	...
	const int w1round = (w1lambda < 0.5) ? 0 : 1;
    //
    if (packed) {
      const Dtype* pos1 = &data1[channels * ((y1 + h1) * Width1 + (x1 + w1))];
      Dtype* pos2 = &data2[channels * ((y2 + h2) * Width2 + (x2 + w2))];
	...
	pos2++;
      ...
      for (int c = 0; c < channels; ++c) {
	  if (is_seglabel) {
			pos2[0] = pos1[h1round * h1p * Width1 + w1round * w1p];
	  }
	  else {
	     pos2[0] =
...
void caffe_gpu_interp2(const int channels,
  ...
  caffe_gpu_interp2_kernel<Dtype,packed><<<CAFFE_GET_BLOCKS(num_kernels), CAFFE_CUDA_NUM_THREADS>>>
    (num_kernels, rheight, rwidth, channels,
     ...
     data2, x2, y2, height2, width2, Height2, Width2, is_seglabel);
...
// Explicit instances
template void caffe_gpu_interp2<float,false>(const int, const float *, const int, const int, const int, const int, const int, const int, float *, const int, const int, const int, const int, const int, const int, bool);
template void caffe_gpu_interp2<float,true>(const int, const float *, const int, const int, const int, const int, const int, const int, float *, const int, const int, const int, const int, const int, const int, bool);
template void caffe_gpu_interp2<double,false>(const int, const double *, const int, const int, const int, const int, const int, const int, double *, const int, const int, const int, const int, const int, const int, bool);
template void caffe_gpu_interp2<double,true>(const int, const double *, const int, const int, const int, const int, const int, const int, double *, const int, const int, const int, const int, const int, const int, bool);
